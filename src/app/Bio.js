...
//     // Function to handle checkbox toggle for keywords
...
//     // Function to handle checkbox toggle for looking options
...
//           <div style={{ fontWeight: "bold", fontSize: "18px", marginTop: "6px" }}>{name}</div>
//           <div style={{ fontSize: "15px", marginTop: "4px", fontWeight: "700" }}>{gender}</div>
    
//       </div>
//     </div>

//     <div style={{ textAlign: "center", marginBottom: "20px" }}>
//       <button style={{ marginRight: "10px" }} onClick={() => setOption("Description")}>Description</button>
//       <button style={{ marginRight: "10px" }} onClick={() => setOption("Photos")}>Photos</button>
//       <button style={{ marginRight: "10px" }} onClick={() => setOption("Keywords")}>Keywords</button>
//       <button onClick={() => setOption("Looking For")}>Looking For</button>
//     </div>
