...
export default function Bio() {
    ...
    //     try {
    //         const response = await axios.get(`http://https://projectmateweb-back.onrender.com/users/${userId}`);
    ...
    //             `http://https://projectmateweb-back.onrender.com/users/${userId}/description`,
    ...
    //     try {
    //         const response = await axios.post(`http://https://projectmateweb-back.onrender.com/users/${userId}/project-images`, {
    //             imageUrl: imageUrl
    //         });
...
const addLookingFor= async (lookingFor)=>{
  try {
    const response = await axios.put(
      `http://https://projectmateweb-back.onrender.com/users/${userId}/looking-for`,
      {
...
const removeLookingFor = async (lookingFor) => {
  try {
    const response = await axios.put(
      `http://https://projectmateweb-back.onrender.com/users/${userId}/looking-for/remove`,
      {
        lookingFor: lookingFor,
      }
    );
...
const addKeywords= async (keywords)=>{
  try {
    const response = await axios.put(
      `http://https://projectmateweb-back.onrender.com/users/${userId}/keywords/add`,
      {
        keywords: keywords,
      }
    );
...
try {
  const response = await axios.put(
    `http://https://projectmateweb-back.onrender.com/users/${userId}/keywords/remove`,
    {
      keywords: keywords,
    }
  );
